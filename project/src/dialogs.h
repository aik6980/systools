...
void systools_dialogs_open_file( const char *title, const char *msg, const char *initialdir, struct ARG_FILEFILTERS *filters, int multi, struct RES_STRINGLIST *result) ;
